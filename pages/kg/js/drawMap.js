    ...
    $(document).ready(function () {
        $.ajax({
            ...
            success: function (response) {
                ...
                length_firstfact = data["children"].length;
                if(length_firstfact <= 4) {
                    temp_scale = 1.2;
                }else if(length_firstfact < 8) {
                    temp_scale = 1.1;
                }else {
                    temp_scale = 1;
                }
                var tree4 = buildTree(data, seed4, temp_scale);
                draw_tree(tree4, seed4, svg2, temp_scale);
                /*****************************************************/
                //对分面树进行缩放
                multiple = 1;
                $(window).bind('mousewheel', function(evt) {
                    ...
                    if( 0.3< multiple && multiple <= temp_scale){
